...
+      <SiteHeader />
+      <main>
+        <PageHero eyebrow="Frequently asked questions" title="Clear answers for complex financial decisions" body="Every divorce is different, but the right questions can reveal risks, trade-offs and opportunities before a settlement becomes permanent.">
...
+                    <span className="flex gap-4"><span className="mt-1 text-xs text-brass">{String(index + 1).padStart(2, "0")}</span>{question}</span>
